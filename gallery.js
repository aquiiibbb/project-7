...
const imageData = [
  ...
  { id: 2, caption: 'Hotel near area university', category: 'Exterior' },
  { id: 3, caption: 'Hotel exterior', category: 'Exterior' },
  { id: 4, caption: 'Hotel near popular attractions', category: 'Exterior' },
  { id: 5, caption: 'Hotel exterior', category: 'Exterior' },
  { id: 6, caption: 'Hotel lobby', category: 'Lobby' },
  { id: 7, caption: 'Front desk with friendly staff', category: 'Lobby' },
  { id: 8, caption: 'Front desk', category: 'Lobby' },
  { id: 9, caption: 'Lobby with sitting area', category: 'Lobby' },
  { id: 10, caption: 'Guest room with queen bed(s)', category: 'Rooms & Suites' },
  { id: 11, caption: 'Guest room with king bed(s)', category: 'Rooms & Suites' },
  ...
  { id: 15, caption: 'Guest room with desk area', category: 'Rooms & Suites' },
  ...
  { id: 19, caption: 'Spacious suite with added amenities', category: 'Rooms & Suites' },
  { id: 20, caption: 'King suite with whirlpool bathtub', category: 'Rooms & Suites' },
  { id: 21, caption: 'Free breakfast', category: 'Breakfast Area' },
  ...
  { id: 24, caption: 'Relax on the sundeck', category: 'Amenities' },
  { id: 25, caption: 'Outdoor pool', category: 'Amenities' },
  { id: 26, caption: 'Outdoor pool', category: 'Amenities' },
  { id: 27, caption: 'Business center', category: 'Amenities' },
];
